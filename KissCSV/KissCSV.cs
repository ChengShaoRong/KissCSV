...
namespace KissFramework
{
    ...
    public class KissCSV
    {
        ...
        /// <summary>
        /// Get the bool value from CSV file.
        /// E.G. "Item.csv" file content is below:
        /// "
        /// id,name,maxStack,enable
        /// 100,"item name",9999,false
        ...
        {
            return Convert.ToBoolean(GetString(fileName, strUniqueKey, strColumnName, bDefault.ToString()));
        }
        /// <summary>
        ...
        /// <summary>
        /// Get the BooleanList value from CSV file, and split by '|'.
        /// E.G. "Item.csv" file content is below:
        /// "
        /// id,name,maxStack,testList
        ...
        /// <summary>
        /// Get the StringBooleanDictionary value from CSV file, and split by '|' and '_', but the string can't contain '|' and '_' itself.
        /// E.G. "Item.csv" file content is below:
        /// "
        /// id,name,maxStack,testDictionary
        ...
        /// <summary>
        /// Get the IntBooleanDictionary value from CSV file, and split by '|' and '_'.
        /// E.G. "Item.csv" file content is below:
        /// "
        /// id,name,maxStack,testDictionary
        ...
        public static Dictionary<int, bool> GetIntBooleanDictionary(string fileName, string strUniqueKey, string strColumnName)
        {
            ...
            foreach (string s in strs)
            {
                string[] strss = s.Split('_');
                if (strss.Length == 2)
                    ret[Convert.ToInt32(strss[0])] = Convert.ToBoolean(strss[1]);
            }
            return ret;
        }
        /// <summary>
